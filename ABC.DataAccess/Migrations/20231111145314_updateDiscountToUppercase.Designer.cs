...
namespace ABC.DataAccess.Migrations
{
    ...
    [Migration("20231111145314_updateDiscountToUppercase")]
    partial class updateDiscountToUppercase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ABC.Models.UserManagement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactNumber = 9568271611L,
                            DateCreated = new DateTime(2023, 11, 11, 22, 53, 14, 354, DateTimeKind.Local).AddTicks(5577),
