...
namespace ABC.DataAccess.Migrations
{
    ...
    [Migration("20231111133956_addeddiscountAndCharge")]
    partial class addeddiscountAndCharge
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ABC.Models.UserManagement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactNumber = 9568271611L,
                            DateCreated = new DateTime(2023, 11, 11, 21, 39, 55, 743, DateTimeKind.Local).AddTicks(7911),
